...
function locationIcon(kind) {
  const icons = {
    ...
    cosmetics: `<path d="M2.5 12h4v9h-4zM3.3 12V8.7l2.4-2.1V12M2.5 15.5h4"/><path class="location-icon-soft" d="M6.8 13.1c3.8-5 6.9-4.7 8.8-1.1 2.1-3.1 4.8-1.8 7 1.1-3.2 6.5-12.4 6.5-15.8 0Z"/><path d="M6.8 13.1c3.8-5 6.9-4.7 8.8-1.1 2.1-3.1 4.8-1.8 7 1.1-3.2 6.5-12.4 6.5-15.8 0ZM8.2 13.7c4.6 1.5 8.8 1.5 13.1 0"/>`,
